...
public class DriverCode 
{
    ...
    public static void main(String args[]) 
    {
        ...
        System.out.println(DSObj.bChain.lastBlock.dgst);
        ...
        //try 
        {
            ...
            tobj.Destination = m2;
            tobj.coinID = "100002";
            Pair<List<Pair<String, String>>,List<Pair<String, String>>> p=null;
            System.out.println("p initialised");
            System.out.println(tobj);
            try{
            p = m3.finalizeCoinsend(tobj,DSObj);
            System.out.println("p finalised");
            }
            catch(Exception e)
            {
